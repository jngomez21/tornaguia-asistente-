...
import { colorPorTipo } from '../components/ResultadoSolicitud'
    ...
    <div className="min-h-dvh flex bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-5xl mx-auto p-6 sm:p-10">
          <h1 className="text-2xl font-bold text-marca-oscuro mb-1">Historial de solicitudes</h1>
          <p className="text-sm text-gray-500 mb-6">Consultas de tornaguía que has realizado.</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-100 text-left text-xs text-gray-500 uppercase tracking-wide">
                    ...
                    <th className="px-4 py-3 font-semibold">Tornaguía</th>
                  </tr>
                </thead>
                <tbody>
                  {historialFiltrado.map((item) => (
                    <tr key={item.solicitudId} className="border-b border-gray-50 last:border-0">
                      <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{formatearFecha(item.fechaSolicitud)}</td>
                      ...
                      <td className="px-4 py-3 text-gray-600">{item.estaDeclarado ? 'Sí' : 'No'}</td>
                      <td className="px-4 py-3">
                        {item.tienePdf ? (
                          <button
                            type="button"
                            ...
                            className="flex items-center gap-1.5 text-marca-oscuro font-semibold hover:underline disabled:opacity-50"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 text-marca-medio font-semibold hover:underline disabled:opacity-50"
                          >
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4">
